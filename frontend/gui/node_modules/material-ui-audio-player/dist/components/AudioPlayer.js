...
var AudioPlayer = function (_a) {
    var _b, _c;
    var src = _a.src, _d = _a.rounded, rounded = _d === void 0 ? true : _d, _e = _a.elevation, elevation = _e === void 0 ? 1 : _e, _f = _a.useStyles, useStyles = _f === void 0 ? function () { return ({}); } : _f, _g = _a.width, width = _g === void 0 ? '100%' : _g, _h = _a.height, height = _h === void 0 ? 'auto' : _h, _j = _a.variation, variation = _j === void 0 ? AudioPlayerVariation.default : _j, _k = _a.preload, preload = _k === void 0 ? AudioPlayerPreload.auto : _k, _l = _a.volume, volume = _l === void 0 ? true : _l, _m = _a.download, download = _m === void 0 ? false : _m, _o = _a.autoplay, autoplay = _o === void 0 ? false : _o, _p = _a.order, order = _p === void 0 ? AudioPlayerComponentsOrder.standart : _p, _q = _a.loop, loop = _q === void 0 ? false : _q, _r = _a.debug, debug = _r === void 0 ? false : _r, _s = _a.spacing, spacing = _s === void 0 ? undefined : _s, _t = _a.time, time = _t === void 0 ? 'double' : _t, _u = _a.timePosition, timePosition = _u === void 0 ? 'start' : _u, icons = _a.icons, _v = _a.onPlayed, onPlayed = _v === void 0 ? function (event) { } : _v, _w = _a.onPaused, onPaused = _w === void 0 ? function (event) { } : _w, _x = _a.onFinished, onFinished = _x === void 0 ? function (event) { } : _x;
    ...
    var _y = React.useState(true), showCurrentTime = _y[0], toggleTime = _y[1];
    var toggleCurrentTime = React.useCallback(function () { return toggleTime(function (val) { return !val; }); }, [
        toggleTime,
    ]);
    var _z = React.useReducer(reducer_1.default, inititalState), state = _z[0], dispatch = _z[1];
    var _0 = React.useMemo(function () {
        return helpers_1.populateDispatch.apply(void 0, __spreadArrays([dispatch, player], actions_1.actionCreators));
    }, [dispatch, player, actions_1.actionCreators]), _playAudio = _0[0], _pauseAudio = _0[1], _muteAudio = _0[2], _unmuteAudio = _0[3], _changeAudioVolume = _0[4], _setPlayerDuration = _0[5], _setPlayerTime = _0[6], _audioEnded = _0[7], _replayAudio = _0[8], _changePlayerSlider = _0[9], _setPlayerAutoplay = _0[10], _loopAudio = _0[11];
    ...
    return (React.createElement(Grid_1.default, { container: true, spacing: mainContainerSpacing, component: Paper_1.default, alignItems: "center", className: classnames_1.default(classes.root, classes["elevation" + elevation], (_b = {},
        ...
        volume && (React.createElement(AudioVolumeControl_1.default, { muteAudio: _muteAudio, unmuteAudio: _unmuteAudio, classNames: classNames, changeAudioVolume: _changeAudioVolume, volume: state.player.volume, playerColors: playerColors })),
        React.createElement(Grid_1.default, { item: true, container: true, spacing: 2, className: classnames_1.default(classes.sliderContainerWrapper) },
